function survey_update()
    ...
    local surveymini = (ALUI and ALUI.surveymini) or alui.surveymini
    local SurveyContainer = (ALUI and ALUI.GUI and ALUI.GUI.Components and ALUI.GUI.Components.Survey_Container) or GUI.Survey_Container
